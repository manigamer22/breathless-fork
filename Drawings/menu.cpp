...
void cMenu::renderCheckbox(int x, int y, const char* str, bool* var) {
    ...
    int size = 10;
    Color col = Color(163, 12, 224, 255);
...
void cMenu::renderAim(int x, int y) {
   ...
   // Resolve.push_back("Brute");
    ...
    this->renderCheckbox(x + 200, y + 103, "Hitscan", &vars.aimbot.hitscan);
    //this->renderCheckbox(x + 200, y + 123, "FakeWalk", &vars.aimbot.fakewalk);
    this->renderCombo(x + 200, y + 123, 110, 20, "Hitscan", hitscan, vars.aimbot.hitscantype, &vars.hitscan_opend);
    //this->renderCombo(x + 200, y + 163, 110, 20, "Fakewalk", fakewalk, vars.aimbot.fakewalktype, &vars.fakewalk_opend);
    ...
    //this->renderCheckbox(x + 300, y + 103, "Freestanding", &vars.misc.edge);
...
void cMenu::renderVis(int x, int y) {
    ...
    this->renderCheckbox(x + 150, y + 143, "AA Indicators", & vars.visuals.antiaim_indicator);
    ...
    this->renderCombo(x + 150, y + 163, 125, 20, "Lit", Indicator, vars.visuals.indicatorAA_types, &vars.indicatorAA_opend);
...
void cMenu::renderMenu() {
    ...
    switch (curTab) {
        ...
        case mTab::RageTab:
            draw->RectOutlined(x + 2, y + 22 + 5, 96, 25, 1, Color(12, 12, 12, 255), Color(163, 12, 224, 255));
            this->renderAim(x + 2 + 5, y + 27 + 20 + 5);
            break;
            
        case mTab::PlayerTab:
            draw->RectOutlined(x + 102, y + 22 + 5, 96, 25, 1, Color(12, 12, 12, 255), Color(163, 12, 224, 255));
            this->renderPlayer(x + 2 + 5, y + 27 + 20 + 5);
            break;
            
        case mTab::VisTab:
            draw->RectOutlined(x + 202, y + 22 + 5, 96, 25, 1, Color(12, 12, 12, 255), Color(163, 12, 224, 255));
            this->renderVis(x + 2 + 5, y + 27 + 20 + 5);
            break;
            
        case mTab::MiscTab:
            draw->RectOutlined(x + 302, y + 22 + 5, 96, 25, 1, Color(12, 12, 12, 255), Color(163, 12, 224, 255));
            this->renderMisc(x + 2 + 5, y + 27 + 20 + 5);
            break;
            
        case mTab::ColorsTab:
            draw->RectOutlined(x + 402, y + 22 + 5, 96, 25, 1, Color(12, 12, 12, 255), Color(163, 12, 224, 255));
